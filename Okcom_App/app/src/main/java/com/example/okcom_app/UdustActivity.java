...
public class UdustActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_udust);
        ...
        LineDataSet dataset = new LineDataSet(entries, "초미세먼지");

        LineData data = new LineData(labels, dataset);
//        dataset.setColor(ContextCompat.getColor(getConText(), R.color.));
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                Call<Result> call = apiService.getSensorData("udust");
            ...
            protected void onPostExecute(String s) {
                ...
                Call<Result> getCall = mMyAPI.getSensorData("udust");
